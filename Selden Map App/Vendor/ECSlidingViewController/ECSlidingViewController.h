...
/**
 Returns the number of points the top view is visible when in the preview position on the left side
*/
@property (nonatomic, unsafe_unretained) CGFloat previewLeftPeekAmount;
...
-(BOOL)underRightShowingCompletely;
