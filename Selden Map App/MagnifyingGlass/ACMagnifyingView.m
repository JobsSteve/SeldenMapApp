...
- (id)initWithFrame:(CGRect)frame {
	if (self = [super initWithFrame:frame]) {
        ...
        [self addMagnifyingGlassAtPoint:CGPointMake(0, 0)];
	}
	return self;
}
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    //test touch point, if it is hitting the magnifying glass update the glasses location when its moved, otherwise do nothing. 
